  ...
  stages {
    stage('Inicio') {
      ...
      properties([parameters([
        ...
        [$class: 'CascadeChoiceParameter', choiceType: 'PT_SINGLE_SELECT', filterLength: 1, filterable: false, 
            name: 'stopTrigger', randomName: 'choice-parameter-9465507565539136', 
            referencedParameters: 'componente', script: [$class: 'GroovyScript', fallbackScript: [classpath: [], sandbox: false, script: ''], script: [classpath: [], sandbox: false, script: """
            if(componente.equals('trigger')){ return ['false', 'true']  }else { return ['none'] } """]]]
